...
#Develop an algorithm to match candidates to the locations based on their preferences.If two candidates choose same location
#and there is only vacancy in that location,we allocate the location based on the candidate's marks.
class candidate:
